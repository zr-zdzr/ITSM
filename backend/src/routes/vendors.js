...
router.get('/', requireAuth, perm('vendors','read'), async (_req, res, next) => {
  try {
...
router.post('/', requireAuth, perm('vendors','create'), async (req, res, next) => {
  try {
...
router.put('/:id', requireAuth, perm('vendors','update'), async (req, res, next) => {
  try {
...
router.delete('/:id', requireAuth, perm('vendors','delete'), async (req, res, next) => {
  try {
