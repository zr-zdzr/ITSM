  ...
  try {
    ...
    if (force || Number(existEmp.rows[0].count) === 0) {
      const EMPLOYEES = [
        ...
        {
          name: "Bilal Siddiqui",
          email: "bilal.siddiqui@bykea.com",
          des: "DevOps Engineer",
          dept: "IT",
          mob: "0345-5000005",
          loc: "Karachi",
        ...
        {
          name: "Ayesha Noor",
          email: "ayesha.noor@bykea.com",
          des: "Business Analyst",
          dept: "Operations",
          mob: "0311-6000006",
          loc: "Lahore",
          et: "Permanent",
      ...
      for (const m of MOBILES) {
        await db.query(
          ...
          [
            ...
            m.model,
            m.sn.toUpperCase(),
            m.imei.toUpperCase() || null,
            m.imei2.toUpperCase() || null,
            m.os,
            m.dept,
            m.loc,
            m.atype,
      ...
      for (let i = 0; i < ITEMS.length; i++) {
        ...
        await db.query(
          `INSERT INTO inv_stock (item_id, qty_available) VALUES ($1, $2)
           ON CONFLICT (item_id) DO UPDATE SET qty_available = EXCLUDED.qty_available`,
          [itemId, STOCK[i]],
        );
        count++;
      }
